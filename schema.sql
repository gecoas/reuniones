...
ALTER TABLE minutes ADD COLUMN IF NOT EXISTS attendees TEXT NOT NULL DEFAULT '';
ALTER TABLE minutes ADD COLUMN IF NOT EXISTS summary TEXT NOT NULL DEFAULT '';
ALTER TABLE minutes ADD COLUMN IF NOT EXISTS agreements TEXT NOT NULL DEFAULT '';
ALTER TABLE minutes ADD COLUMN IF NOT EXISTS pending TEXT NOT NULL DEFAULT '';
ALTER TABLE minutes ADD COLUMN IF NOT EXISTS audio_url TEXT;
ALTER TABLE school_settings ADD COLUMN IF NOT EXISTS email_from_name TEXT;
ALTER TABLE school_settings ADD COLUMN IF NOT EXISTS email_from_address TEXT;
